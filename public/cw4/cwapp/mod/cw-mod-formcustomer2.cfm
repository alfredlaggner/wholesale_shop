...
==========================================================
File: cw-mod-formcustomer2.cfm
File Date: 2014-11-17
Description: Modified AM: added wholesale cust. type 2 - creates and displays customer information form, handles updates
==========================================================
--->

<cfparam name="session.cwclient.cwCustomerID" default="0">
<cfparam name="session.cwclient.cwCustomerType" default="2">
...
<cfparam name="request.cwpage.customerGuest" default="2">
...
<cfif isDefined('form.customer_email')>
	...
	<cfif not len(request.cwpage.formErrors)>
		...
		<cfif isDefined('application.cw.customerAccountRequired') and application.cw.customerAccountRequired eq false
				...
				and form.customer_type_id neq 2>
			<cfset request.cwpage.dupCheck = false>
		<cfelse>
...
<cfif not isNumeric(customerQuery.customer_type_id)>
	<cfset customer_type = 2>
<cfelse>
	<cfset customer_type = customerQuery.customer_type_id>
</cfif>
<cfparam name="form.customer_type_id" default="2">
